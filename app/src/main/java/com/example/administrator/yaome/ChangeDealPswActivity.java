...
public class ChangeDealPswActivity extends AppCompatActivity {
    //返回按钮
    ...
    private void save(){
        save_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isEqually()){
                    Toast.makeText(ChangeDealPswActivity.this, "两次输入相同", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ChangeDealPswActivity.this, "两次输入不相同，请重新输入", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
